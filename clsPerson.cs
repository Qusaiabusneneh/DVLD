...
namespace DVLD_Buisness
{
    public class clsPerson
    {
        ...
        {
            this.PersonID = clsPeopleDataAccess.clsPeopleDataAccess.AddNewPerson(
        ...
        {
            return clsPeopleDataAccess.clsPeopleDataAccess.UpdatePerson(
        ...
        public static clsPerson Find(int PersonID)
        {
            ...
            short Gendor = 0;
            bool IsFound = clsPeopleDataAccess.clsPeopleDataAccess.GetPersonInfoByID
                                (
        ...
        public static clsPerson Find(string NationalNo)
        {
            ...
            bool IsFound = clsPeopleDataAccess.clsPeopleDataAccess.GetPersonInfoByNationalNo
                              (
                                NationalNo, ref  FirstName, ref  SecondName, ref  ThirdName,
                                ref  LastName, ref  PersonID, ref  DateOfBirth, ref  Gendor, ref  Address,
        ...
        {
            return clsPeopleDataAccess.clsPeopleDataAccess.GetAllPeople();
        }
        public static bool DeletePerson(int PersonID)
        {
            return clsPeopleDataAccess.clsPeopleDataAccess.DeletePerson(PersonID);
        }
        public static bool isPersonExist(int PersonID)
        {
            return clsPeopleDataAccess.clsPeopleDataAccess.IsPersonExist(PersonID);
        }
        public static bool isPersonExist(string NationlNo)
        {
            return clsPeopleDataAccess.clsPeopleDataAccess.IsPersonExist(NationlNo);
        }
    }
}
