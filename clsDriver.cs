...
namespace DVLD_BuisnessLayer
{
    public class clsDriver
    {
        ...
        public static clsDriver FindByDriverID(int DriverID)
        {
            ...
            bool isFound = clsDriverDataAccess.GetDriverInfoByDriverID(DriverID, ref PersonID, ref CreatedByUserID, ref CreatedDate);
        ...
        public static clsDriver FindByPersonID(int PersonID)
        {
            ...
            bool isFound = clsDriverDataAccess.GetDriverInfoByPersonID(PersonID,ref DriverID,ref CreatedByUserID,ref CreatedDate);
        ...
        {
            this.DriverID = clsDriverDataAccess.AddNewDriver(PersonID,CreatedByUserID);
